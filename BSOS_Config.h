...
#define BSOS_SLOW_DOWN_LAMP_STROBE  1 // 0
...
#define BSOS_SCORE_AWARD_1_EEPROM_START_BYTE      70
#define BSOS_SCORE_AWARD_2_EEPROM_START_BYTE      74
#define BSOS_SCORE_AWARD_3_EEPROM_START_BYTE      78
